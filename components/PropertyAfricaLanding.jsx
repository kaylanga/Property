...
export default function PropertyAfricaLanding() {
  ...
  useEffect(() => {
    ...
    setFeaturedProperties(
      randomProperties.slice(0, 3).map((prop) => ({
        ...prop,
        featured: true,
      })),
    );
    ...
    setAiRecommendations(
      randomProperties.slice(3, 5).map((prop, idx) => ({
        ...prop,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-xl mb-8">
              Discover the finest homes, apartments, and commercial properties
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Properties personalized to your preferences
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {aiRecommendations.map((property) => (
              <div
                key={property.id}
                className="flex flex-col md:flex-row bg-white rounded-xl overflow-hidden shadow-lg"
              >
                ...
                <div className="md:w-3/5 p-6">
                  ...
                  <div className="text-2xl font-bold text-blue-600 mb-4">
                    {currency === "UGX" && (
                      <span>UGX {property.price.UGX}</span>
                    )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
              ...
              <p className="text-gray-600 text-center mb-6">
                Securely pay using international credit and debit cards via
                Stripe.
              </p>
              <div className="flex space-x-4">
                <Image
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
              ...
              <p className="text-gray-600 text-center mb-6">
                Pay using local mobile money options for seamless transactions.
              </p>
              <div className="flex space-x-4">
                <Image
                  src={paymentIcons.mtnMobileMoney}
                  alt="MTN Mobile Money"
                  width={60}
                  height={40}
                />
                <Image
                  src={paymentIcons.airtelMoney}
                  alt="Airtel Money"
                  width={60}
                  height={40}
                />
                <Image
                  src={paymentIcons.mpesa}
                  alt="M-Pesa"
                  width={60}
                  height={40}
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Find your perfect property with our powerful search filters and
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                View property prices in multiple currencies for easier
      ...
      <section className="py-16 bg-blue-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              href="/properties"
              className="bg-white text-blue-700 hover:bg-gray-100 px-8 py-3 rounded-lg font-bold"
            >
              Browse Properties
            </Link>
            <Link
              href="/signup"
              className="bg-transparent border-2 border-white hover:bg-blue-800 px-8 py-3 rounded-lg font-bold"
            >
              Create Account
            </Link>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Your trusted real estate platform in East Africa.
              </p>
              <div className="flex space-x-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Property Africa. All rights
              reserved.
            </p>
          </div>
        </div>
