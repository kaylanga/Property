    ...
    try {
      ...
      const sampleProperties = [
        ...
        },
        {
          ...
          bedrooms: 5,
          bathrooms: 4,
          image_url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
          created_at: now,
        },
        {
          title: 'Cozy Family Home',
          description: 'Perfect family home in a quiet neighborhood with schools nearby.',
          price: 280000,
      ...
      console.error('Error adding sample properties:', err);
      setError(err.message || 'Failed to add sample properties');
    }
  };
    ...
    return (
      <div className="bg-yellow-50 dark:bg-yellow-900/20 p-6 rounded-lg text-center">
        ...
        <p className="text-yellow-700 dark:text-yellow-300 mb-4">
          Your database is connected, but it looks like it's empty.
        </p>
        <button
